...
mkdir -p "$tmp/docs/skills/ecp-onboard"
...
---
name: ecp-onboard
when-to-use: User says install ecp
---
body
EOF
assert_exit 1 bash "$LINT" "$tmp/docs/skills/ecp-onboard"
...
---
name: ecp-onboard
description: Personalized installation wizard for egent-code-plexus.
when-to-use: User says install ecp / set up egent-code-plexus.
---
- Jump table:
