...
- **ALWAYS use `gnx` CLI commands (e.g., `gnx context`, `gnx impact`, `gnx query`) to analyze and understand code across the workspace before writing or refactoring code.**
