Registry + repo health (indexed repos, freshness, frameworks, blind spots). External-client (HTTP/DB/Redis/queue) usage detail: see `cgn tool-map`

Usage: cgn coverage [OPTIONS]
