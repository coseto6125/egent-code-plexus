...
- License text: [LICENSE](../LICENSE) (also at [LICENSES/PolyForm-Noncommercial-1.0.0.txt](./PolyForm-Noncommercial-1.0.0.txt))
...
- License text: [LICENSES/MIT.txt](./MIT.txt)
...
- License text: [LICENSES/MPL-2.0.txt](./MPL-2.0.txt)
