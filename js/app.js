...
const K = Object.freeze({
    ...
    // 3-way benchmark tables
    TBL_3W_VSCODE_HEADING: 'table.vscode3w.heading',
    TBL_3W_GITNEXUS_HEADING: 'table.gitnexus3w.heading',
    TBL_3W_METRIC: 'table.3way.metric',
    TBL_3W_CAPTION: 'table.3way.caption',
    TBL_3W_COLD_INDEX: 'table.row.cold_index',
    TBL_3W_PEAK_RSS: 'table.row.peak_rss',
    TBL_3W_FIND_QUERY: 'table.row.find_query',
    TBL_3W_CALLERS_IMPACT: 'table.row.callers_impact',
    TBL_3W_INSPECT_CTX: 'table.row.inspect_ctx',
    TBL_3W_IMPACT_BASELINE: 'table.row.impact_baseline',
    TBL_3W_GRAPH_NODES: 'table.row.graph_nodes',
    TBL_3W_GRAPH_EDGES: 'table.row.graph_edges',
    TBL_3W_INDEX_SIZE: 'table.row.index_size',
    TBL_3W_FILES_INDEXED: 'table.row.files_indexed',
...
const TRANSLATIONS = {
    'zh-TW': {
        ...
        [K.TBL_3W_VSCODE_HEADING]: 'microsoft/vscode — 14,874 個檔案',
        [K.TBL_3W_GITNEXUS_HEADING]: 'abhigyanpatwari/GitNexus — 3,232 個檔案（多語言）',
        [K.TBL_3W_METRIC]: '指標',
        [K.TBL_3W_CAPTION]: '※ ecp 0.4.2 · codegraph 0.9.4 · gitnexus 1.6.5；所有工具於可設定時限制 max-file-size 為 1 MiB（gitnexus 固定為 512 KB）；ecp = 無狀態 CLI，每次延遲含完整行程啟動；ecp 為 5–7 次運行的中位數。',
        [K.TBL_3W_COLD_INDEX]: 'Cold index',
        [K.TBL_3W_PEAK_RSS]: '峰值 RSS',
        [K.TBL_3W_FIND_QUERY]: 'Find / query',
        [K.TBL_3W_CALLERS_IMPACT]: 'Callers / impact',
        [K.TBL_3W_INSPECT_CTX]: 'Inspect / context',
        [K.TBL_3W_IMPACT_BASELINE]: 'Impact baseline (git-diff)',
        [K.TBL_3W_GRAPH_NODES]: 'Graph 節點',
        [K.TBL_3W_GRAPH_EDGES]: 'Graph 邊',
        [K.TBL_3W_INDEX_SIZE]: '索引大小',
        [K.TBL_3W_FILES_INDEXED]: '已索引檔案',
    ...
    'zh-CN': {
        ...
        [K.TBL_3W_VSCODE_HEADING]: 'microsoft/vscode — 14,874 个文件',
        [K.TBL_3W_GITNEXUS_HEADING]: 'abhigyanpatwari/GitNexus — 3,232 个文件（多语言）',
        [K.TBL_3W_METRIC]: '指标',
        [K.TBL_3W_CAPTION]: '※ ecp 0.4.2 · codegraph 0.9.4 · gitnexus 1.6.5；所有工具在可配置时将 max-file-size 限制为 1 MiB（gitnexus 固定为 512 KB）；ecp = 无状态 CLI，每次延迟含完整进程启动；ecp 为 5–7 次运行的中位数。',
        [K.TBL_3W_COLD_INDEX]: 'Cold index',
        [K.TBL_3W_PEAK_RSS]: '峰值 RSS',
        [K.TBL_3W_FIND_QUERY]: 'Find / query',
        [K.TBL_3W_CALLERS_IMPACT]: 'Callers / impact',
        [K.TBL_3W_INSPECT_CTX]: 'Inspect / context',
        [K.TBL_3W_IMPACT_BASELINE]: 'Impact baseline (git-diff)',
        [K.TBL_3W_GRAPH_NODES]: 'Graph 节点',
        [K.TBL_3W_GRAPH_EDGES]: 'Graph 边',
        [K.TBL_3W_INDEX_SIZE]: '索引大小',
        [K.TBL_3W_FILES_INDEXED]: '已索引文件',
    ...
    'en': {
        ...
        [K.TBL_3W_VSCODE_HEADING]: 'microsoft/vscode — 14,874 files',
        [K.TBL_3W_GITNEXUS_HEADING]: 'abhigyanpatwari/GitNexus — 3,232 files (polyglot)',
        [K.TBL_3W_METRIC]: 'Metric',
        [K.TBL_3W_CAPTION]: '※ ecp 0.4.2 · codegraph 0.9.4 · gitnexus 1.6.5; all tools capped at 1 MiB max-file-size where configurable (gitnexus hard-codes 512 KB); ecp = stateless CLI, every latency includes full process startup; ecp medians over 5–7 runs.',
        [K.TBL_3W_COLD_INDEX]: 'Cold index',
        [K.TBL_3W_PEAK_RSS]: 'Peak RSS',
        [K.TBL_3W_FIND_QUERY]: 'Find / query',
        [K.TBL_3W_CALLERS_IMPACT]: 'Callers / impact',
        [K.TBL_3W_INSPECT_CTX]: 'Inspect / context',
        [K.TBL_3W_IMPACT_BASELINE]: 'Impact baseline (git-diff)',
        [K.TBL_3W_GRAPH_NODES]: 'Graph nodes',
        [K.TBL_3W_GRAPH_EDGES]: 'Graph edges',
        [K.TBL_3W_INDEX_SIZE]: 'Index size',
        [K.TBL_3W_FILES_INDEXED]: 'Files indexed',
    ...
    'ja': {
        ...
        [K.TBL_3W_VSCODE_HEADING]: 'microsoft/vscode — 14,874 ファイル',
        [K.TBL_3W_GITNEXUS_HEADING]: 'abhigyanpatwari/GitNexus — 3,232 ファイル（多言語）',
        [K.TBL_3W_METRIC]: '指標',
        [K.TBL_3W_CAPTION]: '※ ecp 0.4.2 · codegraph 0.9.4 · gitnexus 1.6.5；設定可能な場合、全ツールの max-file-size を 1 MiB に制限（gitnexus は 512 KB 固定）；ecp = ステートレス CLI、各レイテンシはプロセス起動を含む；ecp は 5–7 回の実行の中央値。',
        [K.TBL_3W_COLD_INDEX]: 'Cold index',
        [K.TBL_3W_PEAK_RSS]: 'ピーク RSS',
        [K.TBL_3W_FIND_QUERY]: 'Find / query',
        [K.TBL_3W_CALLERS_IMPACT]: 'Callers / impact',
        [K.TBL_3W_INSPECT_CTX]: 'Inspect / context',
        [K.TBL_3W_IMPACT_BASELINE]: 'Impact baseline (git-diff)',
        [K.TBL_3W_GRAPH_NODES]: 'Graph ノード',
        [K.TBL_3W_GRAPH_EDGES]: 'Graph エッジ',
        [K.TBL_3W_INDEX_SIZE]: 'インデックスサイズ',
        [K.TBL_3W_FILES_INDEXED]: 'インデックス済みファイル',
    ...
    'ko': {
        ...
        [K.TBL_3W_VSCODE_HEADING]: 'microsoft/vscode — 14,874 개 파일',
        [K.TBL_3W_GITNEXUS_HEADING]: 'abhigyanpatwari/GitNexus — 3,232 개 파일 (다중 언어)',
        [K.TBL_3W_METRIC]: '지표',
        [K.TBL_3W_CAPTION]: '※ ecp 0.4.2 · codegraph 0.9.4 · gitnexus 1.6.5; 설정 가능한 경우 모든 도구의 max-file-size를 1 MiB로 제한 (gitnexus는 512 KB 고정); ecp = 무상태 CLI, 모든 지연 시간에 전체 프로세스 시작 포함; ecp는 5–7회 실행의 중앙값.',
        [K.TBL_3W_COLD_INDEX]: 'Cold index',
        [K.TBL_3W_PEAK_RSS]: '피크 RSS',
        [K.TBL_3W_FIND_QUERY]: 'Find / query',
        [K.TBL_3W_CALLERS_IMPACT]: 'Callers / impact',
        [K.TBL_3W_INSPECT_CTX]: 'Inspect / context',
        [K.TBL_3W_IMPACT_BASELINE]: 'Impact baseline (git-diff)',
        [K.TBL_3W_GRAPH_NODES]: 'Graph 노드',
        [K.TBL_3W_GRAPH_EDGES]: 'Graph 엣지',
        [K.TBL_3W_INDEX_SIZE]: '인덱스 크기',
        [K.TBL_3W_FILES_INDEXED]: '인덱싱된 파일',
    ...
    'es': {
        ...
        [K.TBL_R12]: 'Impact baseline HEAD~1',
        [K.TBL_NOTE]: '※ Hardware: AMD Ryzen 9 9950X, 39.2 GiB RAM, Linux 6.6.87',
        [K.TBL_3W_VSCODE_HEADING]: 'microsoft/vscode — 14,874 archivos',
        [K.TBL_3W_GITNEXUS_HEADING]: 'abhigyanpatwari/GitNexus — 3,232 archivos (políglota)',
        [K.TBL_3W_METRIC]: 'Métrica',
        [K.TBL_3W_CAPTION]: '※ ecp 0.4.2 · codegraph 0.9.4 · gitnexus 1.6.5; todos los tools limitados a 1 MiB max-file-size donde sea configurable (gitnexus fijado en 512 KB); ecp = CLI sin estado, cada latencia incluye inicio completo del proceso; medianas de ecp sobre 5–7 ejecuciones.',
        [K.TBL_3W_COLD_INDEX]: 'Cold index',
        [K.TBL_3W_PEAK_RSS]: 'Pico RSS',
        [K.TBL_3W_FIND_QUERY]: 'Find / query',
        [K.TBL_3W_CALLERS_IMPACT]: 'Callers / impact',
        [K.TBL_3W_INSPECT_CTX]: 'Inspect / context',
        [K.TBL_3W_IMPACT_BASELINE]: 'Impact baseline (git-diff)',
        [K.TBL_3W_GRAPH_NODES]: 'Nodos del grafo',
        [K.TBL_3W_GRAPH_EDGES]: 'Aristas del grafo',
        [K.TBL_3W_INDEX_SIZE]: 'Tamaño del índice',
        [K.TBL_3W_FILES_INDEXED]: 'Archivos indexados',
