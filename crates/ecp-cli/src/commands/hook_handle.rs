//! `ecp hook-handle <stage>`: invoked by reference-transaction hook.
//! On `committed`, parses stdin for branch DELETE events and spawns
//! detached watchers via ecp-core daemon helper.
...
pub fn run(args: HookHandleArgs) -> Result<(), ecp_core::EcpError> {
    ...
    for branch in deleted {
        ...
        let _ = ecp_core::daemon::spawn_detached(&args_vec);
    }
