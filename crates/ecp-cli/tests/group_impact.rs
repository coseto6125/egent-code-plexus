...
//!
//! 2. **CLI smoke test** — verifies `ecp group impact --help` exits 0 and that
...
/// `ecp group impact --help` must exit 0 and mention the subcommand.
#[test]
