...
//!
//! Exercises the production `KAFKA_TS` const and the real `frameworks.scm`
...
//! lowercase) because KAFKA_TS sets `canonicalize: true`.

use ecp_analyzer::event_topic::{extract_event_topics, KAFKA_TS};
