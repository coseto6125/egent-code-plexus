...
//! Emits a hardcoded framework-coverage table (the patterns gnx-analyzer
...
use clap::Args;
use gnx_analyzer::framework_confidence as fc;
use gnx_core::{GnxError, HIGH_TRUST_CONFIDENCE};
