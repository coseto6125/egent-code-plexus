...
use gnx_cli::search::TantivyEngine;
use gnx_core::graph::{File, Node, NodeKind, ZeroCopyGraph, GRAPH_FORMAT_VERSION, GRAPH_MAGIC};
...
fn make_graph_with_names(names: &[&str]) -> ZeroCopyGraph {
    ...
    ZeroCopyGraph {
        ...
        files: vec![File {
            ...
            mtime: 0,
            content_hash: [0; 32],
            category: gnx_core::graph::FileCategory::Source,
        }],
        nodes,
        edges: vec![],
        out_offsets: vec![0, 0],
