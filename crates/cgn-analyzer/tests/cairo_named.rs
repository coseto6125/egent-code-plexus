...
fn test_cairo_use_as_alias_emits_typedef() {
    ...
    assert_eq!(n.1, NodeKind::Typedef, "aliased use-import must be NodeKind::Typedef");
}
...
fn test_cairo_type_alias_emits_typedef() {
    ...
    assert_eq!(n.1, NodeKind::Typedef, "type alias must be NodeKind::Typedef");
}
...
fn test_cairo_type_alias_with_generics_emits_typedef() {
    ...
    assert_eq!(n.1, NodeKind::Typedef, "generic type alias must be NodeKind::Typedef");
}
