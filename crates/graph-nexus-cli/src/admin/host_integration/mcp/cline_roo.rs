//! Stub leaf — Cline / Roo Code MCP integration.
...
pub fn install(_theme: &ColorfulTheme) {
    println!("Cline / Roo Code MCP install — coming in subproject C.");
}

pub fn uninstall(_theme: &ColorfulTheme) {
    println!("Cline / Roo Code MCP uninstall — coming in subproject C.");
}
